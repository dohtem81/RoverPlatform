...
src/BlackADC.o: /home/strus/workspace/BlackLib/v2_0/BlackADC.cpp
	...
	arm-linux-gnueabihf-g++-4.7 -I"/home/strus/workspace/BlackLib/v2_0" -I"/home/strus/workspace/Inotify" -I/usr/arm-linux-gnueabihf/include/c++/4.7.2 -O0 -g3 -Wall -c -fmessage-length=0 -std=c++0x -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
